...
const Benefits = () => {
  return (
    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 items-center justify-between flex-wrap gap-10 bg-gradient-to-t from-[#fcc175] to-[#f8821e] md:bg-gradient-to-r md:from-[#f8821e] md:to-[#fcc175] text-white py-6 px-6 md:py-6 md:px-12 lg:py-10 lg:px-20' style={{borderRadius: '10px'}}>
      <div className='flex items-center justify-center gap-6'>
        ...
        <div className='flex flex-col gap-1'>
          ...
          <p className='text-sm leading-5'>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
        </div>
      </div>
