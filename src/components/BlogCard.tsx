...
const BlogCard = () => {
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-start justify-between gap-10'>
      {blogDetails.map((blog) => (
        ...
        >
          ...
          <div className='flex flex-col gap-4 px-6 py-6'>
            ...
            <div className='flex items-center justify-between gap-4 mt-4 opacity-70 blogIcon'>
